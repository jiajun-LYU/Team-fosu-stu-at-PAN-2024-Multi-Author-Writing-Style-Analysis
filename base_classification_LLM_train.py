...
train_data = PAN('/H10/clef/multi-author-analysis/data',4200,"hard","train")
valid_data = PAN('/H10/clef/multi-author-analysis/data',900,"hard","validation")
...
fname = f"score.original_module.pt"
torch.save(lora_model.model.score.original_module.state_dict(), fname)
